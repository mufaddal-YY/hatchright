...
const Logo = forwardRef(({ disabledLink = false, sx, ...other }, ref) => {
  ...
  const logo = (
    <Box
      ...
      {...other}
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="209.365" height="50.696" viewBox="0 0 209.365 50.696">
  <g id="Group_27435" data-name="Group 27435" transform="translate(-101.025 -110.806)">
    <text id="hatchright" transform="translate(164.389 145.365)" fill="#4612c6" font-size="27" font-family="Poppins-SemiBold, Poppins" font-weight="600"><tspan x="0" y="0">hatch</tspan><tspan y="0" fill="#ffb000">right</tspan></text>
