...
import DatabaseTableFiltersResult from '../database-table-filters-result';
...
export default function DatabaseListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.database.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.database.new}
              variant="contained"
